        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          >
            <motion.p
              ...
              className="text-ecospace-green font-semibold uppercase tracking-wider mb-4"
            ...
            >
              {title}
              <br />
              <span className="text-ecospace-green">{category}</span>
            </motion.h2>
            <motion.p
              variants={itemVariants}
            ...
            <motion.div variants={itemVariants}>
              <Link
                href="/podcast"
                className="inline-block bg-ecospace-green hover:bg-ecospace-green-dark text-white font-bold py-4 px-8 rounded-full transition-all shadow-lg hover:shadow-xl transform hover:scale-105 uppercase tracking-wide"
              ...
              >
                ...
                >
                  ...
                  <div className="flex-shrink-0">
                    <div className="w-14 h-14 rounded-full bg-ecospace-green hover:bg-ecospace-green-dark flex items-center justify-center transition-all duration-300 shadow-md">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-ecospace-green font-bold mb-1" style={{ fontSize: '14px', fontWeight: 700 }}>
                      Episode {episode.episodeNumber} . {episode.category}
                    </p>
                    <h3 className="text-black font-bold mb-1 line-clamp-2 group-hover:text-ecospace-green transition-colors" style={{ fontSize: '19px', fontWeight: 700, lineHeight: '1.4' }}>
                      {episode.title}
                    </h3>
                  </div>
                </Link>
